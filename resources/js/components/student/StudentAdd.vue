                      ...
                      <div class="col-sm-8">
                        <fieldset>
                          <div class="form-check abc-radio abc-radio-info form-check-inline">
                            <input class="form-check-input" type="radio" id="one" value="M" v-model="student.gender">
                            <label class="form-check-label" for="one">Nam</label>
                          </div>
                          <div class="form-check abc-radio form-check-inline">
                            <input class="form-check-input" type="radio" id="two" value="F" v-model="student.gender">
                            <label class="form-check-label" for="two">Nữ</label>
                          </div>
                        </fieldset>

                        <span>Picked: {{ student.gender }}</span>
                      </div>
                    </div>
